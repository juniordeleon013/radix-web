...
function ValueSection() {
  ...
  const values = [
    ...
    },
    {
      ...
      description: "Acompañamiento durante tu tratamiento para maximizar resultados y resolver dudas.",
    },
    {
      icon: Microscope,
              ...
              <div className="flex items-start mb-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 mb-3">
                    WhatsApp: <strong>+1 (849) 340-8364</strong>
                  </p>
                  <a
                    href="https://wa.me/18493408364?text=Hola%20Radix,%20quisiera%20más%20información"
                    target="_blank"
                    rel="noopener noreferrer"
